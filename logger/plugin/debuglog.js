...
define(function(require) {
	var meld, timer, defaultTimeout, createTracer, logger, ownProp;
	...
	var rest = require("rest"),
		...
		client = rest.wrap(mime, { mime: 'application/json'}).wrap(entity);
	...
	function logStack(e) {
		...
		client({path: "logger/error", entity: {error: stack} }).then(function(response) {
