 ...
 * }
 */
(function(global, define, logStack, logger) {
define(function(require) {
	...
	(function(global, define){
		define(function(require) {
			...
			global['console'] = {
				log: function(msg){
					oldconsole.log("NEW LOG::::", msg)
					client({path: "logger/error", entity: {message: msg} }).then(function(response) {
					    oldconsole.log('response: ', response);
					});
				},
				error: function(err){
					oldconsole.log("ERROR:::", err) 
					// client({path: "logger/error", entity: {error: err}}).then(function(response) {
					//     oldconsole.log('response: ', response);
					// });
				}
			}
